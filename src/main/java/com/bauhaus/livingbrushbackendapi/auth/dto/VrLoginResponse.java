...
public record VrLoginResponse(
        ...
        @Schema(description = "사용자 닉네임", example = "아티스트")
        String nickname,

        @Schema(description = "AI 기능 사용 가능 여부", example = "true")
     ...
     * @param aiFeaturesEnabled AI 기능 사용 가능 여부
     * @return VR 로그인 응답
     */
    public static VrLoginResponse from(AuthResponse authResponse, String nickname, Boolean aiFeaturesEnabled) {
     ...
     * @return VR 로그인 응답
     */
    public static VrLoginResponse of(String accessToken, String refreshToken, Long userId, UserRole role, String nickname, Boolean aiFeaturesEnabled) {
        return new VrLoginResponse(accessToken, refreshToken, userId, role, nickname, aiFeaturesEnabled);
    }
}